const Publications = () => {
  const publications = [
    ...
    //   date: "Dec 2023",
    //   description:
    //     "A comprehensive guide on building scalable web applications using React, Node.js, and microservices architecture.",
    //   link: "#",
    ...
    //   date: "Oct 2023",
    //   description:
    //     "Exploring emerging trends in frontend development including Web3, AI integration, and new frameworks.",
    //   link: "#",
    ...
    //   date: "Aug 2023",
    //   description:
    //     "Video tutorial comparing CSS Grid and Flexbox with practical examples and use cases.",
    //   link: "#",
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p
            ...
            data-testid="publications-description"
          >
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-3">
                    <div className="flex items-center gap-3 mb-2 sm:mb-0">
                      <span
                        ...
                        data-testid={`pub-type-${index}`}
                      >
                        {pub.type}
                      </span>
                      <span
                        className="text-sm text-muted-foreground"
                        data-testid={`pub-platform-${index}`}
                      >
                        {pub.platform}
                      </span>
                    </div>
                  ...
                  <p
                    ...
                    data-testid={`pub-description-${index}`}
                  >
                    {pub.description}
                  </p>
