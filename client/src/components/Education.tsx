const Education = () => {
  const education = [
    {
      degree:
        "Bachelor of Science (BS) and Master of Science (MS) (Dual Degree)",
      school:
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div>
            {/* <h3
              ...
              data-testid="formal-education-title"
            >
              Formal Education
            </h3> */}
            <div className="grid grid-cols-1 gap-8">
              {education.map((edu, index) => (
                <div
                  key={index}
                  className="bg-background border border-border rounded-2xl p-8 hover-elevate"
                >
                  <div className="mb-4">
                    <h4
          ...
          {/* <div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {certifications.map((cert, index) => (
                <div
                  key={index}
                  className="bg-background border border-border rounded-xl p-6 text-center hover-elevate"
                >
